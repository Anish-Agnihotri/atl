		...
		<div className="App">
			...
			<div className="pageItem">
				<div className="home-cta">
					<div>
						<img src={shield} alt='Shield animation' />
						<h1>Trading Automated</h1>
						<h1>w/ onchain peers</h1>
						<p>Set, forget, and sell with AirSwap handling your trading orders with no middleman. Using our onchain peer protocol, set limit and partial fill orders to be executed at varying token exchange prices.</p>
						<div>
							<Link to="/dashboard">Make Orders</Link>
							<Link to="/explore">Explore Orders</Link>
						</div>
					</div>
				</div>
			</div>
